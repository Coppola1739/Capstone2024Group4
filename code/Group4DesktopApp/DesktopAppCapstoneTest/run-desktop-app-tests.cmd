...
"%UserProfile%\.nuget\packages\reportgenerator\5.2.0\tools\net8.0\ReportGenerator.exe" -reports:./TestResults\*\coverage.cobertura.xml -targetdir:coveragereport -filefilters:-*\View*;-*\UserControls*;-*\Model\AlertDialog.cs;-*\App.xaml.cs 
