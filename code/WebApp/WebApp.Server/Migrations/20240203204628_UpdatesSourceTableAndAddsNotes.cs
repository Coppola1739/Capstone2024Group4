...
{
    /// <inheritdoc />
    public partial class UpdatesSourceTableAndAddsNotes : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NoteTags", x => new { x.TagName, x.NotesId });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthorFirstName = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    AuthorLastName = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
